...
GLS_SHIPMENT_ERROR_CODES = {
    ...
    -49: "Error, EuroEstandar/EBP service: weight should be <= 40 kgs (<Peso>).",
    ...
    -53: (
        ...
        "EuroEstandar/EBP service; or ParcelShop service: Destinatario/Codigo "
        "(ParcelShop point code) is mandatory and was not informed."
    ),
    -54: (
        "Error, EuroEstandar/EBP service:"
    ...
    -135: "Error, Consignee phone is mandatory for 10:30 and 08:30 services.",
    -355: "Error, Consignee zipcode belongs to a restricted area.",
    -680: "Error, Sender country does not match sender zipcode/origin agency code.",
    -690: "Error, Sender country does not match sender zipcode/origin agency code.",
    -803: "Error, Consignee phone is mandatory for the selected ParcelShop point.",
